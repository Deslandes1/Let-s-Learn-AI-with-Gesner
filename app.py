...
# ---------- LESSONS DATA (WITH NAMES ON LEFT FOR SPECIFIED LESSONS, NO SYMBOLS) ----------
lessons = [
    {
    ...
    {
        "title": "Google Gemini - Lesson 2: Google Gemini – Multimodal Power",  # name on left
    ...
    {
        "title": "Midjourney - Lesson 8: Midjourney – AI Image Generator",  # name on left
    ...
    {
        "title": "Leonardo.ai - Lesson 10: Leonardo.ai – Free Image Generation",  # name on left
    ...
    {
        "title": "Runway ML - Lesson 11: Runway ML – AI Video Editor",  # name on left
    ...
    {
        "title": "Stable Diffusion - Lesson 13: Stable Diffusion – Open Source Image Gen",  # name on left
    ...
    {
        "title": "AgentGPT - Lesson 16: AgentGPT – Browser Agent",  # name on left
    ...
    {
        "title": "OpenAssistant - Lesson 19: OpenAssistant – Community LLM",  # name on left
