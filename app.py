...
lessons = {
    ...
    "fr": [
        {
            "title": "Leçon 1 : ChatGPT – Votre assistant IA",
            "text": "**Ce qu'il fait :** ChatGPT d'OpenAI est une IA conversationnelle qui peut répondre aux questions, écrire du code, créer du contenu, etc. Il prend en charge la navigation Web, l'interprétation de code et la génération d'images (DALL-E).\n\n**Installation sur téléphone :** Téléchargez l'application officielle ChatGPT sur l'App Store ou Google Play. Inscrivez-vous avec un e-mail ou Google. Niveau gratuit disponible. Pour les fonctionnalités avancées (GPT-4, plugins), abonnez-vous à ChatGPT Plus (20 $/mois).\n\n**Installation sur ordinateur :** Rendez-vous sur chat.openai.com. Créez un compte. Utilisez directement dans le navigateur. Installez l'application de bureau (Windows/Mac) pour une meilleure entrée vocale.",
            "read_aloud": "ChatGPT d'OpenAI est une IA conversationnelle qui peut répondre aux questions, écrire du code et créer du contenu. Installation : téléchargez l'application sur téléphone ou visitez le site web sur ordinateur.",
            "image": "https://upload.wikimedia.org/wikipedia/commons/e/ef/ChatGPT-Logo.svg",
            "no_image": False
        },
        {
            "title": "Google Gemini – Leçon 2 : Google Gemini – Puissance multimodale",
            "text": "**Ce qu'il fait :** Gemini (anciennement Bard) est l'IA la plus avancée de Google. Il comprend le texte, les images, l'audio et la vidéo. Intégré à Google Workspace (Gmail, Docs, Drive).\n\n**Installation sur téléphone :** Installez l'application Google Gemini (Android) ou utilisez l'application Google sur iOS avec Gemini activé. Connectez-vous avec votre compte Google.\n\n**Installation sur ordinateur :** Rendez-vous sur gemini.google.com. Connectez-vous. Utilisez directement. Pour les fonctionnalités avancées, abonnez-vous à Gemini Advanced (inclus dans Google One AI Premium).",
            "read_aloud": "Google Gemini est l'IA la plus avancée de Google. Il comprend le texte, les images, l'audio et la vidéo. Installation : utilisez l'application sur téléphone ou visitez le site web sur ordinateur.",
            "image": "",
            "no_image": True
        },
        {
            "title": "Leçon 3 : DeepSeek – Le codeur efficace",
            "text": "**Ce qu'il fait :** DeepSeek est une IA de codage et de raisonnement très efficace, connue pour son faible coût et son long contexte (1 million de tokens). Idéal pour la programmation, les mathématiques et l'analyse technique.\n\n**Installation sur téléphone :** Utilisez l'application mobile DeepSeek (disponible sur les magasins officiels) ou accédez via le navigateur à chat.deepseek.com.\n\n**Installation sur ordinateur :** Rendez-vous sur chat.deepseek.com. Aucune connexion requise pour une utilisation de base. Créez un compte pour sauvegarder les discussions. Modèles gratuits et open‑weight disponibles.",
            "read_aloud": "DeepSeek est une IA de codage et de raisonnement efficace. Installation : utilisez l'application mobile ou visitez le site web. Gratuit.",
            "image": "https://upload.wikimedia.org/wikipedia/commons/e/ec/DeepSeek_logo.svg",
            "no_image": False
        },
        {
            "title": "Leçon 4 : Grok – Spirituel et temps réel",
            "text": "**Ce qu'il fait :** Grok par xAI (Elon Musk) est conçu pour être spirituel, rebelle et accéder aux données X (Twitter) en temps réel. Il peut répondre à l'actualité avec attitude.\n\n**Installation sur téléphone :** Téléchargez l'application X (Twitter). Grok est disponible pour les abonnés X Premium+. Pas d'application autonome pour l'instant.\n\n**Installation sur ordinateur :** Rendez-vous sur x.com, abonnez-vous à Premium+, puis accédez à Grok depuis la barre latérale. Intégration web et X en temps réel.",
            "read_aloud": "Grok par xAI est spirituel et accède aux données X en temps réel. L'installation nécessite un abonnement X Premium+.",
            "image": "https://abs.twimg.com/responsive-web/client-web/icon-ios.77d25eba.png",
            "no_image": False
        },
        {
            "title": "Leçon 5 : Claude – IA sûre et éthique",
            "text": "**Ce qu'il fait :** Claude d'Anthropic se concentre sur la sécurité, l'honnêteté et la serviabilité. Excellent pour les longs documents (100 000+ tokens), l'analyse et l'écriture créative.\n\n**Installation sur téléphone :** Téléchargez l'application Claude sur l'App Store (iOS) ou utilisez le navigateur web sur Android. Inscrivez-vous avec un e-mail.\n\n**Installation sur ordinateur :** Rendez-vous sur claude.ai. Niveau gratuit disponible. Le plan Pro (20 $/mois) offre plus d'utilisation et un accès prioritaire.",
            "read_aloud": "Claude d'Anthropic est sûre et éthique. Idéal pour les longs documents. Installation via application ou site web.",
            "image": "https://upload.wikimedia.org/wikipedia/commons/8/8a/Claude_AI_logo.svg",
            "no_image": False
        },
        {
            "title": "Leçon 6 : GitHub Copilot – Programmeur pair IA",
            "text": "**Ce qu'il fait :** Copilot suggère du code et des fonctions entières en temps réel dans VS Code, JetBrains et d'autres IDE. Prend en charge de nombreux langages.\n\n**Installation sur téléphone :** Pas d'IDE sur téléphone actuellement. Utilisez GitHub Codespaces sur le navigateur mobile avec Copilot activé.\n\n**Installation sur ordinateur :** Installez VS Code, installez l'extension Copilot, connectez-vous avec votre compte GitHub (gratuit pour les étudiants/enseignants vérifiés, 10 $/mois sinon).",
            "read_aloud": "GitHub Copilot est un programmeur pair IA qui suggère du code dans votre éditeur. Installation via l'extension VS Code.",
            "image": "https://upload.wikimedia.org/wikipedia/commons/0/0a/GitHub_Copilot_%282025%29.svg",
            "no_image": False
        },
        {
            "title": "Leçon 7 : Perplexity AI – Recherche + Réponse",
            "text": "**Ce qu'il fait :** Perplexity est un moteur de recherche alimenté par l'IA qui donne des réponses directes avec des citations. La version Pro peut rechercher des articles académiques, YouTube et utiliser plusieurs modèles d'IA.\n\n**Installation sur téléphone :** Installez l'application Perplexity. Inscrivez-vous avec Google/Apple.\n\n**Installation sur ordinateur :** Rendez-vous sur perplexity.ai. Gratuit. L'abonnement Pro (20 $/mois) débloque plus de fonctionnalités.",
            "read_aloud": "Perplexity AI est un moteur de réponse avec citations. Installation via application ou site web.",
            "image": "https://upload.wikimedia.org/wikipedia/commons/1/1d/Perplexity_AI_logo.svg",
            "no_image": False
        },
        {
            "title": "Midjourney – Leçon 8 : Midjourney – Générateur d'images IA",
            "text": "**Ce qu'il fait :** Midjourney génère des images époustouflantes à partir de descriptions textuelles. Fonctionne dans Discord. Connu pour ses styles artistiques.\n\n**Installation sur téléphone :** Installez Discord, rejoignez le serveur Midjourney. Utilisez la commande /imagine. Essai gratuit limité, puis abonnement (10–120 $/mois).\n\n**Installation sur ordinateur :** Même chose – utilisez l'application de bureau Discord ou la version web.",
            "read_aloud": "Midjourney génère des images à partir de texte dans Discord. Nécessite un abonnement après l'essai.",
            "image": "",
            "no_image": True
        },
        {
            "title": "Leçon 9 : DALL‑E 3 – Créateur d'images d'OpenAI",
            "text": "**Ce qu'il fait :** DALL‑E 3 intégré à ChatGPT Plus génère des images très précises à partir de descriptions. Comprend les requêtes complexes.\n\n**Installation sur téléphone :** Utilisez l'application ChatGPT (abonnement Plus).\n\n**Installation sur ordinateur :** chat.openai.com avec compte Plus. Décrivez une image et DALL‑E la créera.",
            "read_aloud": "DALL‑E 3 crée des images à partir de texte dans ChatGPT Plus. Nécessite un abonnement ChatGPT.",
            "image": "https://upload.wikimedia.org/wikipedia/commons/e/ef/ChatGPT-Logo.svg",
            "no_image": False
        },
        {
            "title": "Leonardo.ai – Leçon 10 : Leonardo.ai – Génération d'images gratuite",
            "text": "Leonardo.ai : Ce qu'il fait : Leonardo est une plateforme gratuite (jetons quotidiens) de génération d'images et de vidéos. De nombreux modèles, affinage et éditeur canvas.\n\nInstallation sur téléphone : Utilisez le navigateur sur téléphone, inscrivez-vous sur leonardo.ai.\n\nInstallation sur ordinateur : Rendez-vous sur leonardo.ai, créez un compte. Le niveau gratuit donne 150 jetons/jour.",
            "read_aloud": "Leonardo.ai est une plateforme gratuite de génération d'images. Installation via site web. 150 jetons gratuits par jour.",
            "image": "",
            "no_image": True
        },
        {
            "title": "Runway ML – Leçon 11 : Runway ML – Éditeur vidéo IA",
            "text": "Runway ML : Ce qu'il fait : Runway fournit des outils IA pour le montage vidéo, la suppression de fond vert, la vidéo à partir de texte et le suivi de mouvement. Utilisé par les cinéastes.\n\nInstallation sur téléphone : Application Runway pour iOS. Inscrivez-vous.\n\nInstallation sur ordinateur : Rendez-vous sur runwayml.com. Niveau gratuit avec exportations limitées ; les plans payants commencent à 12 $/mois.",
            "read_aloud": "Runway ML est un éditeur vidéo IA. Installation via application ou site web.",
            "image": "",
            "no_image": True
        },
        {
            "title": "Leçon 12 : ElevenLabs – Clonage vocal et TTS",
            "text": "**Ce qu'il fait :** ElevenLabs crée une synthèse vocale réaliste et un clonage de voix. Utilisé pour les livres audio, le doublage et les voix off IA.\n\n**Installation sur téléphone :** Utilisez le navigateur sur téléphone, inscrivez-vous sur elevenlabs.io. Pas d'application dédiée pour l'instant.\n\n**Installation sur ordinateur :** Rendez-vous sur elevenlabs.io. Le niveau gratuit offre 10 000 caractères/mois. Les plans payants commencent à 5 $/mois.",
            "read_aloud": "ElevenLabs fait de la synthèse vocale réaliste et du clonage de voix. Installation via site web.",
            "image": "https://cdn.simpleicons.org/elevenlabs/000000",
            "no_image": False
        },
        {
            "title": "Stable Diffusion – Leçon 13 : Stable Diffusion – Générateur d'images open source",
            "text": "Stable Diffusion : Ce qu'il fait : Stable Diffusion par Stability AI génère des images à partir de texte. Peut fonctionner localement sur votre propre GPU. De nombreux outils communautaires.\n\nInstallation sur téléphone : Utilisez des applications gratuites comme 'DreamStudio' ou des démos web. Pour une utilisation locale, besoin d'un téléphone puissant.\n\nInstallation sur ordinateur : Installez Automatic1111 WebUI ou ComfyUI. Nécessite Python et un GPU. Ou utilisez des démos gratuites en ligne (Hugging Face).",
            "read_aloud": "Stable Diffusion est un générateur d'images open source. Peut fonctionner localement ou utiliser des démos en ligne.",
            "image": "",
            "no_image": True
        },
        {
            "title": "Leçon 14 : Hugging Face – Hub de modèles IA",
            "text": "**Ce qu'il fait :** Hugging Face héberge des milliers de modèles d'IA gratuits (LLM, image, audio). Fournit également des Spaces pour exécuter des démos et une API d'inférence.\n\n**Installation sur téléphone :** Utilisez le navigateur pour accéder à huggingface.co. Essayez les modèles dans 'Spaces'.\n\n**Installation sur ordinateur :** Créez un compte gratuit. Utilisez l'API d'inférence ou téléchargez des modèles avec la bibliothèque Transformers.",
            "read_aloud": "Hugging Face est un hub de modèles IA gratuits. Installation via site web. Pas d'installation nécessaire.",
            "image": "https://huggingface.co/favicon.ico",
            "no_image": False
        },
        {
            "title": "Leçon 15 : AutoGPT – Agents IA autonomes",
            "text": "**Ce qu'il fait :** AutoGPT est un agent open‑source expérimental qui peut enchaîner des appels LLM pour atteindre des objectifs (recherche, code, navigation web) de manière autonome.\n\n**Installation sur téléphone :** Non recommandé. Nécessite Python et des clés API.\n\n**Installation sur ordinateur :** Clonez le dépôt GitHub, installez Python, obtenez une clé API OpenAI, exécutez dans le terminal. Ou utilisez les versions web (AgentGPT).",
            "read_aloud": "AutoGPT accomplit des tâches multi‑étapes de manière autonome. L'installation nécessite Python et des clés API.",
            "image": "https://upload.wikimedia.org/wikipedia/commons/8/80/Auto_GPT_Logo.png",
            "no_image": False
        },
        {
            "title": "AgentGPT – Leçon 16 : AgentGPT – Agent navigateur",
            "text": "AgentGPT : Ce qu'il fait : AgentGPT est une alternative à AutoGPT basée sur le navigateur. Définissez un objectif, et il tentera de l'atteindre en utilisant un LLM.\n\nInstallation sur téléphone : Utilisez le navigateur sur téléphone, allez sur agentgpt.com. Nécessite une clé API pour certaines fonctionnalités.\n\nInstallation sur ordinateur : agentgpt.com – connectez-vous, fournissez votre clé API OpenAI, lancez un agent. Interface web facile.",
            "read_aloud": "AgentGPT exécute des agents autonomes dans votre navigateur. Installation via site web avec clé API.",
            "image": "",
            "no_image": True
        },
        {
            "title": "Leçon 17 : LangChain – Construire des applications LLM",
            "text": "**Ce qu'il fait :** LangChain est un framework pour construire des applications alimentées par LLM – chaînes, agents, récupération, mémoire.\n\n**Installation sur téléphone :** Pas pour mobile. Utilisez Replit ou GitHub Codespaces sur navigateur mobile.\n\n**Installation sur ordinateur :** Installez avec pip install langchain. Ensuite intégrez avec OpenAI, Hugging Face, etc. Idéal pour les développeurs.",
            "read_aloud": "LangChain est un framework Python pour construire des applications LLM. Installation via pip.",
            "image": "https://cdn.simpleicons.org/langchain/000000",
            "no_image": False
        },
        {
            "title": "Leçon 18 : LlamaIndex – Framework de données",
            "text": "**Ce qu'il fait :** LlamaIndex connecte les LLM à vos propres données (PDF, bases de données, API). Permet le RAG (Retrieval‑Augmented Generation).\n\n**Installation sur téléphone :** Non adapté. Utilisez des notebooks cloud.\n\n**Installation sur ordinateur :** pip install llama-index. Utilisez avec OpenAI ou des modèles locaux. Idéal pour construire des Q&A sur des documents.",
            "read_aloud": "LlamaIndex connecte les LLM à vos données privées. Installation via pip install.",
            "image": "https://www.llamaindex.ai/favicon.ico",
            "no_image": False
        },
        {
            "title": "OpenAssistant – Leçon 19 : OpenAssistant – LLM communautaire",
            "text": "OpenAssistant : Ce qu'il fait : OpenAssistant est un chatbot gratuit et open‑source entraîné par des bénévoles. Peut être exécuté localement ou via une démo.\n\nInstallation sur téléphone : Utilisez la démo du navigateur sur open-assistant.io.\n\nInstallation sur ordinateur : Rendez-vous sur open-assistant.io/chat. Aucune connexion requise. Pour l'auto‑hébergement, suivez les instructions GitHub.",
            "read_aloud": "OpenAssistant est un chatbot communautaire gratuit. Utilisez la démo en ligne ou auto‑hébergez.",
            "image": "",
            "no_image": True
        },
        {
            "title": "Leçon 20 : Poe – Plateforme IA tout‑en‑un",
            "text": "**Ce qu'il fait :** Poe (Platform for Open Exploration) par Quora donne accès à ChatGPT, Claude, Gemini, Llama, etc. dans une seule interface. Créez des bots personnalisés.\n\n**Installation sur téléphone :** Installez l'application Poe (iOS/Android). Inscrivez-vous. Le niveau gratuit inclut des messages quotidiens. L'abonnement débloque plus.\n\n**Installation sur ordinateur :** Rendez-vous sur poe.com. Gratuit. Intègre de nombreux modèles pour comparaison.",
            "read_aloud": "Poe agrège plusieurs modèles d'IA en un seul endroit. Installation via application ou site web.",
            "image": "https://poe.com/favicon.ico",
            "no_image": False
        }
    ],
    "es": [
        {
            "title": "Lección 1: ChatGPT – Tu asistente IA",
            "text": "**Lo que hace:** ChatGPT de OpenAI es una IA conversacional que puede responder preguntas, escribir código, crear contenido y más. Admite navegación web, interpretación de código y generación de imágenes (DALL-E).\n\n**Configuración en el teléfono:** Descargue la aplicación oficial de ChatGPT desde App Store o Google Play. Regístrese con correo electrónico o Google. Nivel gratuito disponible. Para funciones avanzadas (GPT-4, plugins), suscríbase a ChatGPT Plus ($20/mes).\n\n**Configuración en la computadora:** Visite chat.openai.com. Cree una cuenta. Úselo directamente en el navegador. Instale la aplicación de escritorio (Windows/Mac) para una mejor entrada de voz.",
            "read_aloud": "ChatGPT de OpenAI es una IA conversacional que puede responder preguntas, escribir código y crear contenido. Configuración: descargue la aplicación en el teléfono o visite el sitio web en la computadora.",
            "image": "https://upload.wikimedia.org/wikipedia/commons/e/ef/ChatGPT-Logo.svg",
            "no_image": False
        },
        {
            "title": "Google Gemini – Lección 2: Google Gemini – Potencia multimodal",
            "text": "**Lo que hace:** Gemini (anteriormente Bard) es la IA más avanzada de Google. Comprende texto, imágenes, audio y video. Integrado con Google Workspace (Gmail, Docs, Drive).\n\n**Configuración en el teléfono:** Instale la aplicación Google Gemini (Android) o use la aplicación Google en iOS con Gemini habilitado. Inicie sesión con su cuenta de Google.\n\n**Configuración en la computadora:** Visite gemini.google.com. Inicie sesión. Úselo directamente. Para funciones avanzadas, suscríbase a Gemini Advanced (parte de Google One AI Premium).",
            "read_aloud": "Google Gemini es la IA más avanzada de Google. Comprende texto, imágenes, audio y video. Configuración: use la aplicación en el teléfono o visite el sitio web en la computadora.",
            "image": "",
            "no_image": True
        },
        {
            "title": "Lección 3: DeepSeek – El codificador eficiente",
            "text": "**Lo que hace:** DeepSeek es una IA de codificación y razonamiento altamente eficiente, conocida por su bajo costo y contexto largo (1 millón de tokens). Ideal para programación, matemáticas y análisis técnico.\n\n**Configuración en el teléfono:** Use la aplicación móvil DeepSeek (disponible en tiendas oficiales) o acceda a través del navegador a chat.deepseek.com.\n\n**Configuración en la computadora:** Vaya a chat.deepseek.com. No se requiere inicio de sesión para uso básico. Cree una cuenta para guardar chats. Modelos gratuitos y de peso abierto disponibles.",
            "read_aloud": "DeepSeek es una IA de codificación y razonamiento eficiente. Configuración: use la aplicación móvil o visite el sitio web. Gratis.",
            "image": "https://upload.wikimedia.org/wikipedia/commons/e/ec/DeepSeek_logo.svg",
            "no_image": False
        },
        {
            "title": "Lección 4: Grok – Ingenioso y en tiempo real",
            "text": "**Lo que hace:** Grok de xAI (Elon Musk) está diseñado para ser ingenioso, rebelde y acceder a datos de X (Twitter) en tiempo real. Puede responder a eventos actuales con actitud.\n\n**Configuración en el teléfono:** Descargue la aplicación X (Twitter). Grok está disponible para suscriptores de X Premium+. Aún no hay aplicación independiente.\n\n**Configuración en la computadora:** Visite x.com, suscríbase a Premium+, luego acceda a Grok desde la barra lateral. Integración web y X en tiempo real.",
            "read_aloud": "Grok de xAI es ingenioso y accede a datos de X en tiempo real. La configuración requiere suscripción a X Premium+.",
            "image": "https://abs.twimg.com/responsive-web/client-web/icon-ios.77d25eba.png",
            "no_image": False
        },
        {
            "title": "Lección 5: Claude – IA segura y ética",
            "text": "**Lo que hace:** Claude de Anthropic se centra en la seguridad, honestidad y utilidad. Excelente para documentos largos (100k+ tokens), análisis y escritura creativa.\n\n**Configuración en el teléfono:** Descargue la aplicación Claude desde App Store (iOS) o use el navegador web en Android. Regístrese con correo electrónico.\n\n**Configuración en la computadora:** Visite claude.ai. Nivel gratuito disponible. El plan Pro ($20/mes) ofrece más uso y acceso prioritario.",
            "read_aloud": "Claude de Anthropic es segura y ética. Buena para documentos largos. Configuración mediante aplicación o sitio web.",
            "image": "https://upload.wikimedia.org/wikipedia/commons/8/8a/Claude_AI_logo.svg",
            "no_image": False
        },
        {
            "title": "Lección 6: GitHub Copilot – Programador par IA",
            "text": "**Lo que hace:** Copilot sugiere código y funciones completas en tiempo real dentro de VS Code, JetBrains y otros IDE. Admite muchos lenguajes.\n\n**Configuración en el teléfono:** Actualmente no hay IDE para teléfono. Use GitHub Codespaces en el navegador móvil con Copilot habilitado.\n\n**Configuración en la computadora:** Instale VS Code, instale la extensión Copilot, inicie sesión con su cuenta de GitHub (gratis para estudiantes/profesores verificados, $10/mes de lo contrario).",
            "read_aloud": "GitHub Copilot es un programador par IA que sugiere código dentro de su editor. Configuración mediante extensión de VS Code.",
            "image": "https://upload.wikimedia.org/wikipedia/commons/0/0a/GitHub_Copilot_%282025%29.svg",
            "no_image": False
        },
        {
            "title": "Lección 7: Perplexity AI – Búsqueda + Respuesta",
            "text": "**Lo que hace:** Perplexity es un motor de búsqueda impulsado por IA que ofrece respuestas directas con citas. La versión Pro puede buscar artículos académicos, YouTube y usar múltiples modelos de IA.\n\n**Configuración en el teléfono:** Instale la aplicación Perplexity. Regístrese con Google/Apple.\n\n**Configuración en la computadora:** Visite perplexity.ai. Gratis. La suscripción Pro ($20/mes) desbloquea más funciones.",
            "read_aloud": "Perplexity AI es un motor de respuestas con citas. Configuración mediante aplicación o sitio web.",
            "image": "https://upload.wikimedia.org/wikipedia/commons/1/1d/Perplexity_AI_logo.svg",
            "no_image": False
        },
        {
            "title": "Midjourney – Lección 8: Midjourney – Generador de imágenes IA",
            "text": "**Lo que hace:** Midjourney genera imágenes impresionantes a partir de indicaciones de texto. Funciona dentro de Discord. Conocido por sus estilos artísticos.\n\n**Configuración en el teléfono:** Instale Discord, únase al servidor de Midjourney. Use el comando /imagine. Prueba gratuita limitada, luego suscripción ($10–$120/mes).\n\n**Configuración en la computadora:** Igual – use la aplicación de escritorio de Discord o la versión web.",
            "read_aloud": "Midjourney genera imágenes a partir de texto dentro de Discord. Requiere suscripción después de la prueba.",
            "image": "",
            "no_image": True
        },
        {
            "title": "Lección 9: DALL‑E 3 – Creador de imágenes de OpenAI",
            "text": "**Lo que hace:** DALL‑E 3 integrado en ChatGPT Plus genera imágenes muy precisas a partir de descripciones. Comprende indicaciones complejas.\n\n**Configuración en el teléfono:** Use la aplicación ChatGPT (suscripción Plus).\n\n**Configuración en la computadora:** chat.openai.com con cuenta Plus. Describa una imagen y DALL‑E la creará.",
            "read_aloud": "DALL‑E 3 crea imágenes a partir de texto dentro de ChatGPT Plus. Requiere suscripción a ChatGPT.",
            "image": "https://upload.wikimedia.org/wikipedia/commons/e/ef/ChatGPT-Logo.svg",
            "no_image": False
        },
        {
            "title": "Leonardo.ai – Lección 10: Leonardo.ai – Generación de imágenes gratuita",
            "text": "Leonardo.ai: Lo que hace: Leonardo es una plataforma gratuita (fichas diarias) de generación de imágenes y videos. Muchos modelos, ajuste fino y editor de lienzo.\n\nConfiguración en el teléfono: Use el navegador en el teléfono, regístrese en leonardo.ai.\n\nConfiguración en la computadora: Visite leonardo.ai, cree una cuenta. El nivel gratuito ofrece 150 fichas/día.",
            "read_aloud": "Leonardo.ai es una plataforma gratuita de generación de imágenes. Configuración mediante sitio web. 150 fichas gratuitas al día.",
            "image": "",
            "no_image": True
        },
        {
            "title": "Runway ML – Lección 11: Runway ML – Editor de video IA",
            "text": "Runway ML: Lo que hace: Runway proporciona herramientas de IA para edición de video, eliminación de fondo verde, texto a video y seguimiento de movimiento. Utilizado por cineastas.\n\nConfiguración en el teléfono: Aplicación Runway para iOS. Regístrese.\n\nConfiguración en la computadora: Visite runwayml.com. Nivel gratuito con exportaciones limitadas; los planes de pago comienzan en $12/mes.",
            "read_aloud": "Runway ML es un editor de video IA. Configuración mediante aplicación o sitio web.",
            "image": "",
            "no_image": True
        },
        {
            "title": "Lección 12: ElevenLabs – Clonación de voz y TTS",
            "text": "**Lo que hace:** ElevenLabs crea una síntesis de voz realista y clonación de voz. Se utiliza para audiolibros, doblaje y locuciones IA.\n\n**Configuración en el teléfono:** Use el navegador en el teléfono, regístrese en elevenlabs.io. Aún no hay aplicación dedicada.\n\n**Configuración en la computadora:** Visite elevenlabs.io. El nivel gratuito ofrece 10,000 caracteres/mes. Los planes de pago comienzan en $5/mes.",
            "read_aloud": "ElevenLabs hace una síntesis de voz realista y clonación de voz. Configuración mediante sitio web.",
            "image": "https://cdn.simpleicons.org/elevenlabs/000000",
            "no_image": False
        },
        {
            "title": "Stable Diffusion – Lección 13: Stable Diffusion – Generador de imágenes de código abierto",
            "text": "Stable Diffusion: Lo que hace: Stable Diffusion de Stability AI genera imágenes a partir de texto. Puede ejecutarse localmente en su propia GPU. Muchas herramientas comunitarias.\n\nConfiguración en el teléfono: Use aplicaciones gratuitas como 'DreamStudio' o demostraciones web. Para uso local, se necesita un teléfono potente.\n\nConfiguración en la computadora: Instale Automatic1111 WebUI o ComfyUI. Requiere Python y GPU. O use demostraciones gratuitas en línea (Hugging Face).",
            "read_aloud": "Stable Diffusion es un generador de imágenes de código abierto. Puede ejecutarse localmente o usar demostraciones en línea.",
            "image": "",
            "no_image": True
        },
        {
            "title": "Lección 14: Hugging Face – Centro de modelos IA",
            "text": "**Lo que hace:** Hugging Face alberga miles de modelos de IA gratuitos (LLM, imagen, audio). También proporciona Spaces para ejecutar demostraciones y una API de inferencia.\n\n**Configuración en el teléfono:** Use el navegador para acceder a huggingface.co. Pruebe modelos en 'Spaces'.\n\n**Configuración en la computadora:** Cree una cuenta gratuita. Use la 'API de inferencia' o descargue modelos con la biblioteca Transformers.",
            "read_aloud": "Hugging Face es un centro de modelos de IA gratuitos. Configuración mediante sitio web. No se necesita instalación.",
            "image": "https://huggingface.co/favicon.ico",
            "no_image": False
        },
        {
            "title": "Lección 15: AutoGPT – Agentes IA autónomos",
            "text": "**Lo que hace:** AutoGPT es un agente experimental de código abierto que puede encadenar llamadas LLM para lograr objetivos (investigación, código, navegación web) de forma autónoma.\n\n**Configuración en el teléfono:** No recomendado. Requiere Python y claves API.\n\n**Configuración en la computadora:** Clone el repositorio de GitHub, instale Python, obtenga una clave API de OpenAI, ejecute en la terminal. O use versiones web (AgentGPT).",
            "read_aloud": "AutoGPT completa tareas de múltiples pasos de forma autónoma. La configuración requiere Python y claves API.",
            "image": "https://upload.wikimedia.org/wikipedia/commons/8/80/Auto_GPT_Logo.png",
            "no_image": False
        },
        {
            "title": "AgentGPT – Lección 16: AgentGPT – Agente de navegador",
            "text": "AgentGPT: Lo que hace: AgentGPT es una alternativa a AutoGPT basada en navegador. Defina un objetivo e intentará alcanzarlo usando un LLM.\n\nConfiguración en el teléfono: Use el navegador en el teléfono, vaya a agentgpt.com. Requiere clave API para algunas funciones.\n\nConfiguración en la computadora: agentgpt.com – inicie sesión, proporcione su clave API de OpenAI, inicie un agente. Interfaz web fácil.",
            "read_aloud": "AgentGPT ejecuta agentes autónomos en su navegador. Configuración mediante sitio web con clave API.",
            "image": "",
            "no_image": True
        },
        {
            "title": "Lección 17: LangChain – Construir aplicaciones LLM",
            "text": "**Lo que hace:** LangChain es un framework para construir aplicaciones impulsadas por LLM – cadenas, agentes, recuperación, memoria.\n\n**Configuración en el teléfono:** No para móviles. Use Replit o GitHub Codespaces en el navegador móvil.\n\n**Configuración en la computadora:** Instale con pip install langchain. Luego integre con OpenAI, Hugging Face, etc. Ideal para desarrolladores.",
            "read_aloud": "LangChain es un framework de Python para construir aplicaciones LLM. Configuración mediante pip.",
            "image": "https://cdn.simpleicons.org/langchain/000000",
            "no_image": False
        },
        {
            "title": "Lección 18: LlamaIndex – Framework de datos",
            "text": "**Lo que hace:** LlamaIndex conecta LLMs con sus propios datos (PDF, bases de datos, API). Permite RAG (Generación Aumentada por Recuperación).\n\n**Configuración en el teléfono:** No adecuado. Use cuadernos en la nube.\n\n**Configuración en la computadora:** pip install llama-index. Use con OpenAI o modelos locales. Ideal para construir Q&A sobre documentos.",
            "read_aloud": "LlamaIndex conecta LLMs a sus datos privados. Configuración mediante pip install.",
            "image": "https://www.llamaindex.ai/favicon.ico",
            "no_image": False
        },
        {
            "title": "OpenAssistant – Lección 19: OpenAssistant – LLM comunitario",
            "text": "OpenAssistant: Lo que hace: OpenAssistant es un chatbot gratuito y de código abierto entrenado por voluntarios. Se puede ejecutar localmente o mediante demostración.\n\nConfiguración en el teléfono: Use la demostración del navegador en open-assistant.io.\n\nConfiguración en la computadora: Visite open-assistant.io/chat. No se requiere inicio de sesión. Para autoalojamiento, siga las instrucciones de GitHub.",
            "read_aloud": "OpenAssistant es un chatbot comunitario gratuito. Use la demostración en línea o autoalójelo.",
            "image": "",
            "no_image": True
        },
        {
            "title": "Lección 20: Poe – Plataforma IA todo en uno",
            "text": "**Lo que hace:** Poe (Platform for Open Exploration) de Quora brinda acceso a ChatGPT, Claude, Gemini, Llama y más en una sola interfaz. Cree bots personalizados.\n\n**Configuración en el teléfono:** Instale la aplicación Poe (iOS/Android). Regístrese. El nivel gratuito incluye mensajes diarios. La suscripción desbloquea más.\n\n**Configuración en la computadora:** Visite poe.com. Gratis. Integra muchos modelos para comparación.",
            "read_aloud": "Poe agrega múltiples modelos de IA en un solo lugar. Configuración mediante aplicación o sitio web.",
            "image": "https://poe.com/favicon.ico",
            "no_image": False
        }
    ]
